...
def train_one_epoch(
    ...
    for idx, image_info in enumerate(train_loader):
        ...
        sup_loss = args.w_seg * seg_loss + args.w_global * global_loss
...
def run_train(args) -> None:
    ...
    load_base_checkpoint(args.base_ckpt, model, prompt_learner, dino_adapters, device)
    ...
    for epoch in range(args.epoch):
        ...
        print(
            ...
            f"grpo={meters['grpo']:.6f}, reward={meters['reward']:.6f}, "
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--mara_delta_scale", type=float, default=1.0)
