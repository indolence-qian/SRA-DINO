...
#
# Full run:
#   GPU_IDS=0,1 NPROC_PER_NODE=2 bash run_exp_dino_single.sh
# Resume from a trained single-tower base:
#   RUN_BASE=0 BASE_CKPT=./checkpoint/dino_single_visa_xxx/ckpt/single_epoch_14.pth bash run_exp_dino_single.sh
